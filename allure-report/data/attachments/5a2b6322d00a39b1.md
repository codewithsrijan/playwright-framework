...
- Name: selfRegistration.spec.ts >> SelfRegistration — organizations >> Fetch — 200  happy path
- Location: tests/tests-api/selfRegistration.spec.ts:533:7

# Error details

```
Error: Contract mismatch: {"_errors":[],"email":{"_errors":["Invalid input: expected string, received undefined"]},"registrationUuid":{"_errors":["Invalid input: expected string, received undefined"]},"userStatus":{"_errors":["Invalid option: expected one of \"NEW_SELF_REGISTRATION_USER\"|\"VALIDATE_OTP\"|\"CREATE_PASSWORD\"|\"LINK_HAS_EXPIRED\""]}}
