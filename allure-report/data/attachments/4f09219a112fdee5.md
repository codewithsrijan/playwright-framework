...
- Name: selfRegistration.spec.ts >> SelfRegistration — organizations >> DeleteCustomAttribute — 404 not found
- Location: tests/tests-api/selfRegistration.spec.ts:617:7

# Error details

```
Error: apiRequestContext.delete: Fixture { request } from beforeAll cannot be reused in a test.
