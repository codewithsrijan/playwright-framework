...
- main:
  ...
  - heading "PB Components suspendo undique 1779726147426" [level=1]
  - list:
    - listitem:
      - button
    - listitem:
  ...
  - status: Draggable item card-ImageTextCard was dropped over droppable area 055bec48-6f7b-429d-8334-de1517462cc4
- log
- log
- log
- log
...
> 264 |         ).toBeVisible({ timeout: 10_000 });
  ...
  358 | 
  359 | /**
  360 |  * Components that open a configuration picker (e.g. media picker) when dropped on canvas.
  361 |  *
  362 |  * Behaviour confirmed 2026-05-25:
  363 |  *   - Video: opens "Select video" dialog; Cancel dismisses picker AND removes component.
  364 |  *     No canvas data-marker appears — canvas assertion must be skipped.
```