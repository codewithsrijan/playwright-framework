...
- Location: tests/tests-api/selfRegistration.spec.ts:652:7
...
> 655 |     expect(status).toBe(200);
  ...
  750 | });
  751 | 
  752 | test.describe("SelfRegistration — sshealth", () => {
  753 |   test.beforeEach(async () => {
  754 |     await Reporter.setEpic("SelfRegistration");
  755 |     await Reporter.setFeature("sshealth");
```