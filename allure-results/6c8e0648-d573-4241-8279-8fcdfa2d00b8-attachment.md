...
- main:
  ...
  - heading "PB DnD comburo stultus 1779772962442" [level=1]
  - list:
    - listitem:
      - button
    - listitem:
  ...
  - status: Draggable item card-ImageTextCard was dropped over droppable area 31e759a8-0c13-4cb7-b87f-8e56f7b0865f
- log
- log
- log
- log
