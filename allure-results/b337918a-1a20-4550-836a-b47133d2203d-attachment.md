...
- Name: selfRegistration.spec.ts >> SelfRegistration — sshealth >> LocalAndRemoteHealth — 401 unauthorized
- Location: tests/tests-api/selfRegistration.spec.ts:828:7
...
Call log:
  - → GET https://self-registration.develop.squads-dev.com/api/health/v1/all
